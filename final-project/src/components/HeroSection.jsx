  ...
  return (
    <section className=" bg-main-background utline mt-60 md:mt-[500px] px-4 md:px-24 ">
      <div className="px-2 ">
        ...
        <ServiceCard />
        {/* Productive Action */}
        <div className="md:flex md:mt-28 items-center justify-center ">
          <div className="mt-20 md:mt-0 flex justify-center item-center">
            <img
              src={productiveImage}
              alt="productive-illustration"
              className="w-[300px] w-[700px]"
            />
          </div>
          <div className="md:px-14">
            <div className="text-neutral-white mt-10">
              <h3 className="font-semibold text-center md:pr-72 md:text-left text-xl md:text-3xl my-6">
