...
const Contact = () => {
  ...
  return (
    <section className=" flex flex-col items-center justify-center -mt-40 bg-email-bg text-neutral-white  rounded shadow-md absolute mx-4 md:ml-0 right-0 md:right-8 tablet:right-[4rem lg:right-[13rem] md:w-[700px] lg:w-[900px]  md:px-28 md:py-10 top-auto ">
